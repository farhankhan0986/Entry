    ...
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center px-4 font-playfair">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mt-6">
          <Link
            href="/journal"
            className="inline-flex items-center gap-2 border border-[var(--border)] text-[var(--foreground)] hover:border-[var(--accent)] hover:text-[var(--accent)] px-4 py-2 rounded text-sm uppercase transition-all w-fit"
          >
            ← Continue Reading
          </Link>
        </div>
