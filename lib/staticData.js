...
},
{
  ...
  createdAt: "2026-05-10",
  poll: {
    question: "What scares you most about the Russian Sleep Experiment?",
    options: [
      { name: "Losing your mind slowly", color: "#EF4444", votes: 41 },
      { name: "Being trapped without sleep", color: "#3B82F6", votes: 28 },
      { name: "The idea that it feels believable", color: "#10B981", votes: 67 },
      { name: "Humans becoming monsters", color: "#F59E0B", votes: 52 }
    ]
  },
  content: `## The Experiment That Never Happened… But Still Feels Real
...
![style2](https://upload.wikimedia.org/wikipedia/en/4/42/RussianSleepExperimentGuy.png)
